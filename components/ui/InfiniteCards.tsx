        ...
        {items.map((item, idx) => (
          <li
            ...
            className="relative rounded-2xl border border-b-0
             flex-shrink-0 border-slate-800 px-3"
            style={{
              //   background:
          ...
          >
            <blockquote>
              ...
              <div className="relative z-20 flex flex-row items-center justify-center self-center p-2">
                {/* add this div for the profile img */}
                <div className="me-3 flex justify-center items-center flex-col">
                  {item.img ? (
                    <img
                      src={item.img}
                      alt="profile"
                      className="bg-white p-2 w-12 h-12 rounded-full object-cover shadow-lg hover:shadow-2xl transition-all duration-300"
                    />
                  ) : (
                    <img
                      src="/profile.svg"
